...
# DRAFT: Group control: permission - auto promotion:
#  to mod with 7 people supported
#  to admin with 20 - ppl can be set once an admin comes out
...
#
# DRAFT: Json API Doc - Page needed:
# Types:
# - ObjectId
