...
# DRAFT: Group control: permission - auto promote to mod with 7 people supported, to admin with 20 - ppl can be set once an admin comes out
# DRAFT: Group control: role: Similar to permission, but can control certain things, permission gives by mod
# DRAFT: Group control: role: Custom message to create (configurable) and assign role with color
# DRAFT: Group control: role/permission: Can assign color (ONLY available for Discord)
# DRAFT: Group control: funciton setting - turn on/off by mod+ or vote (% by 5 days active member)
...
# TODO: On site - Token Action: List all pending token actions
...
# INCOMPLETE: Auto Reply: Case Insensitive Finding https://docs.mongodb.com/manual/core/index-case-insensitive/ find().collation( { locale: 'en', strength: 1 } )
