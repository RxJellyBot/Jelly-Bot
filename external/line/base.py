...
if not line_token:
    print("Specify Line external access token as LINE_TOKEN in environment variables.")
    sys.exit(1)

line_secret = os.environ.get("LINE_SECRET")
if not line_secret:
    print("Specify Line external secret as LINE_SECRET in environment variables.")
    sys.exit(1)
