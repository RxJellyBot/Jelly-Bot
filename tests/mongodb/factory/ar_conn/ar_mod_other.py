...
class TestAutoReplyModuleManagerOther(TestModelMixin, TestAutoReplyModuleManagerBase.TestClass):
    def test_get_count_call(self):
        mdl = AutoReplyModuleManager.add_conn(**self.get_mdl_1_args()).model
    ...
    def test_get_after_add_multi(self):
        ...
        AutoReplyModuleManager.add_conn(**self.get_mdl_4_args())
        AutoReplyModuleManager.add_conn(**self.get_mdl_6_args())
    ...
    def test_get_list_by_keyword_including_inactive(self):
        ...
        for idx, actual_mdl in enumerate(
                AutoReplyModuleManager.get_conn_list(self.channel_oid, "A", active_only=False)):
    ...
    def test_get_list_by_keyword_active_only(self):
        ...
        for idx, actual_mdl in enumerate(AutoReplyModuleManager.get_conn_list(self.channel_oid, "A")):
            with self.subTest(expected=expected_oids[idx], actual=actual_mdl):
                self.assertEqual(expected_oids[idx], actual_mdl.id)
    ...
    def test_get_list_by_oids(self):
        ...
        for mdl, kw_resp in zip(AutoReplyModuleManager.get_conn_list_oids(mdl_oids), expected_kw_resp):
            kw, resp = kw_resp
    ...
    def test_stats_module_count_length_limited(self):
        ...
        for idx, mdl in enumerate(AutoReplyModuleManager.get_module_count_stats(self.channel_oid, 2)):
    ...
    def test_stats_module_count_length_overlimit(self):
        ...
        for idx, mdl in enumerate(AutoReplyModuleManager.get_module_count_stats(self.channel_oid, 5)):
            kw, resp = expected_kw_resp[idx]
            self.assertEqual(kw, mdl.keyword)
            self.assertEqual(resp, mdl.responses)
    ...
    def test_stats_module_count_length_no_limit(self):
        ...
        for idx, mdl in enumerate(AutoReplyModuleManager.get_module_count_stats(self.channel_oid)):
            kw, resp = expected_kw_resp[idx]
            self.assertEqual(kw, mdl.keyword)
            self.assertEqual(resp, mdl.responses)
    ...
    def test_stats_unique_count_length_limited(self):
        ...
        result = AutoReplyModuleManager.get_unique_keyword_count_stats(self.channel_oid, 3)
    ...
    def test_stats_unique_count_length_overlimit(self):
        ...
        result = AutoReplyModuleManager.get_unique_keyword_count_stats(self.channel_oid, 5)
    ...
    def test_stats_unique_count_length_no_limit(self):
        ...
        result = AutoReplyModuleManager.get_unique_keyword_count_stats(self.channel_oid)
