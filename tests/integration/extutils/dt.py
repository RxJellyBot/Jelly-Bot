...
class TestParseTimeRange(TestCase):
    def test_nfill_all_none(self):
        ...
        self.assertAlmostEqual(0, abs((tr.end - now).total_seconds()), 0)
        ...
        self.assertAlmostEqual(tr.end_time_seconds, time_to_seconds(now), 0)
        prd = tr.get_periods()
    ...
    def test_nfill_range_only(self):
        ...
        self.assertAlmostEqual(0, abs((expected_start - tr.start).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((expected_start - tr.start_org).total_seconds()), 0)
        self.assertIsNone(tr.end)
        self.assertIsNone(tr.tzinfo_)
        self.assertFalse(tr.expandable)
        self.assertFalse(tr.expanded)
        self.assertTrue(tr.is_inf)
        self.assertAlmostEqual(120, tr.hr_length_org, 0)
        self.assertAlmostEqual(120, tr.hr_length, 0)
    ...
    def test_fill_range_hr_0(self):
        ...
        self.assertAlmostEqual(0, abs((expected_start_end - tr.start).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((expected_start_end - tr.start_org).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((tr.end - now).total_seconds()), 0)
        self.assertIsNone(tr.tzinfo_)
        self.assertTrue(tr.expandable)
        self.assertFalse(tr.expanded)
        self.assertFalse(tr.is_inf)
        self.assertAlmostEqual(0, tr.hr_length_org, 0)
        self.assertAlmostEqual(0, tr.hr_length, 0)
    ...
    def test_nfill_start(self):
        ...
        self.assertAlmostEqual(0, abs((start_dt - tr.start).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((start_dt - tr.start_org).total_seconds()), 0)
        self.assertIsNone(tr.end)
        self.assertIsNone(tr.tzinfo_)
        self.assertFalse(tr.expandable)
        self.assertFalse(tr.expanded)
        self.assertTrue(tr.is_inf)
        self.assertAlmostEqual(hr_diff, tr.hr_length_org, 0)
        self.assertAlmostEqual(hr_diff, tr.hr_length, 0)
    ...
    def test_end(self):
        ...
        self.assertIsNone(tr.start)
        self.assertIsNone(tr.start_org)
        self.assertAlmostEqual(0, abs((tr.end - end_dt).total_seconds()), 0)
        self.assertIsNone(tr.tzinfo_)
        self.assertFalse(tr.expandable)
        self.assertFalse(tr.expanded)
        self.assertTrue(tr.is_inf)
        ...
        self.assertAlmostEqual(tr.end_time_seconds, time_to_seconds(end_dt.time()), 0)
        prd = tr.get_periods()
        self.assertListEqual([tr], prd)
    ...
    def test_start_hr_range(self):
        ...
        self.assertAlmostEqual(0, abs((start_dt - tr.start).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((start_dt - tr.start_org).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((tr.end - end_dt_expected).total_seconds()), 0)
        self.assertIsNone(tr.tzinfo_)
        self.assertTrue(tr.expandable)
        self.assertFalse(tr.expanded)
        self.assertFalse(tr.is_inf)
        ...
        self.assertAlmostEqual(tr.end_time_seconds, time_to_seconds(end_dt_expected.time()), 0)
        prd = tr.get_periods()
        self.assertListEqual([tr], prd)
    ...
    def test_end_hr_range(self):
        ...
        self.assertAlmostEqual(0, abs((start_dt_expected - tr.start).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((start_dt_expected - tr.start_org).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((tr.end - end_dt).total_seconds()), 0)
        self.assertIsNone(tr.tzinfo_)
        self.assertTrue(tr.expandable)
        self.assertFalse(tr.expanded)
    ...
    def test_start_end(self):
        ...
        self.assertFalse(tr.expanded)
        self.assertFalse(tr.is_inf)
        self.assertAlmostEqual(48, tr.hr_length_org, 0)
        self.assertAlmostEqual(48, tr.hr_length, 0)
    ...
    def test_mult(self):
        ...
        self.assertAlmostEqual(0, abs((start_mult_expected - tr.start).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((start_dt - tr.start_org).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((tr.end - end_dt).total_seconds()), 0)
        self.assertIsNone(tr.tzinfo_)
        self.assertTrue(tr.expandable)
        ...
        self.assertFalse(tr.is_inf)
        self.assertAlmostEqual(48, tr.hr_length_org, 0)
        self.assertAlmostEqual(96, tr.hr_length, 0)
    ...
    def test_tzinfo(self):
        ...
        self.assertEqual(end_dt, tr.end)
        self.assertNotEqual(start_dt.tzinfo, tr.start.tzinfo)
        self.assertNotEqual(end_dt.tzinfo, tr.end.tzinfo)
        ...
        self.assertAlmostEqual(48, tr.hr_length, 0)
        self.assertEqual(f"{start_dt.strftime('%m-%d')} ~ {end_dt.strftime('%m-%d')}", tr.expr_period_short)
        self.assertAlmostEqual(tr.end_time_seconds, time_to_seconds(localtime(end_dt, tz_).time()), 0)
        prd = tr.get_periods()
        self.assertListEqual([tr], prd)

    def test_tzinfo_start_end_given(self):
        tz_sk = pytz.timezone("Asia/Seoul")
        tz_tw = pytz.timezone("Asia/Taipei")

        start_dt = tz_tw.localize(datetime(2020, 2, 14, 12, 1, 1))
        end_dt = tz_tw.localize(datetime(2020, 2, 16, 12, 1, 1))

        tr = TimeRange(start=start_dt, end=end_dt, tzinfo_=tz_sk)
        self.assertAlmostEqual(0, abs((start_dt - tr.start).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((start_dt - tr.start_org).total_seconds()), 0)
        self.assertAlmostEqual(0, abs((tr.end - end_dt).total_seconds()), 0)
        self.assertEqual(tz_sk.localize(datetime(2020, 2, 14, 13, 1, 1)), tr.start)
        self.assertEqual(tz_sk.localize(datetime(2020, 2, 16, 13, 1, 1)), tr.end)
        self.assertNotEqual(start_dt.tzinfo, tr.start.tzinfo)
        self.assertNotEqual(end_dt.tzinfo, tr.end.tzinfo)
        self.assertEqual(tz_sk, tr.tzinfo_)
        self.assertTrue(tr.expandable)
        self.assertFalse(tr.expanded)
        self.assertFalse(tr.is_inf)
        self.assertAlmostEqual(48, tr.hr_length_org, 0)
        self.assertAlmostEqual(48, tr.hr_length, 0)
        self.assertEqual(f"{start_dt.strftime('%m-%d')} ~ {end_dt.strftime('%m-%d')}", tr.expr_period_short)
        self.assertAlmostEqual(tr.end_time_seconds, time_to_seconds(localtime(end_dt, tz_sk).time()), 0)
        prd = tr.get_periods()
        self.assertListEqual([tr], prd)
