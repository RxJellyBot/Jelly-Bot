...
__all__ = ["TestMapCoordinate", "TestCase"]
...
class TestMapCoordinate(TestCase):
    ...
    def test_apply_offset(self):
        ...
        self.assertEqual(original, MapCoordinate(0, 3))
        self.assertEqual(new, coord)
...
class TestMap(TestCase):
    ...
    def test_new_map_plyr_locn_given(self):
        ...
        self.assertEqual(game_map.height, 2)
    ...
    def test_new_map_players_eq_deployable(self):
        game_map = self.TEMPLATE.to_map(
            players={
                ...
                self.PLAYER_OID_3: Character(get_character_template("Nearnox"))
            }
        )
